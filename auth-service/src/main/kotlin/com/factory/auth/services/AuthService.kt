package com.factory.auth.services
...
import com.factory.auth.utils.JWTUtils
import com.factory.auth.utils.OTPUtils
...
class AuthService(
    ...
    /**
     * Register a new user (manager or staff only)
     */
